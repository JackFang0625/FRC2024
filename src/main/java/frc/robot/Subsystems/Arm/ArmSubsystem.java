...
public class ArmSubsystem extends ProfiledPIDSubsystem {
    ...
    private TalonFX m_armLeader = new TalonFX(CanConstants.ID_ArmLeader, "Drivetrain");
    private TalonFX m_armFollower = new TalonFX(CanConstants.ID_ArmFollower, "Drivetrain");
